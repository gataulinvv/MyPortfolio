...
import { GlobalOutlined, DesktopOutlined, HomeOutlined, MenuUnfoldOutlined, MenuFoldOutlined} from '@ant-design/icons';
...
const SwitcherCollapse = () => {
	...
	var Element = MainLayoutStore.collapsed ? MenuUnfoldOutlined : MenuFoldOutlined;
					...
					<Layout style={{ padding: '0 24px 24px' }} >
						...
						<Content className="site-layout-background" style={{ padding: 24, margin: 0, minHeight: 500 }}>
							...
							<Switch>							
								...
								<Route path="/UsersManagement"><UsersManagement title="Управление пользователями" /></Route>
...
//<Footer style={{ textAlign: 'center' }}> &copy;  Victor Gataulin: gataulinvv@gmail.com</Footer>